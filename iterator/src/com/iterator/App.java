...
import com.iterator.social_networks.SocialNetwork;
...
public class App {
    ...
    public static void main(String[] args) throws Exception {
        ...
        if(choice.equals("2")) network = new LinkedIn(createTestProfiles());
        else network = new Facebook(createTestProfiles());
