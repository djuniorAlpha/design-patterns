...
import com.memento.commands.ColorCommand;
import com.memento.commands.MoveCommand;
	...
	private void attachMouseListeners() {
		MouseAdapter colorizer = new MouseAdapter() {
			...
			public void mousePressed(MouseEvent e) {
				...
				if(target != null) {
					editor.execute(new ColorCommand(editor, new Color((int) (Math.random() * 0x100000))));
					repaint();
				}
			}
		};
		...
		MouseAdapter selector = new MouseAdapter() {
			...
			public void mousePressed(MouseEvent e) {
				...
				if(target == null) {
					if (!ctrl) editor.getShapes().unSelect();
				} else {
					if (ctrl) {
		...
		MouseAdapter dragger = new MouseAdapter() {
			...
			public void mouseDragged(MouseEvent e) {
				if((e.getModifiersEx() & MouseEvent.BUTTON1_DOWN_MASK) != MouseEvent.BUTTON1_DOWN_MASK) return; 
			...
			public void mouseReleased(MouseEvent e) {
				if(e.getButton() != MouseEvent.BUTTON1 || moveCommand == null) return;
